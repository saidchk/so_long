...
void end_animation(s_data *game)
{
  int w;
  int h;
   game->image.pac_tr = mlx_xpm_file_to_image(game->mlx_ptr, "textures/pac_tr.xpm", &w, &h);
	game->image.pac_min_tr = mlx_xpm_file_to_image(game->mlx_ptr, "textures/pac_min_tr.xpm", &w, &h);
	game->image.pac_semi = mlx_xpm_file_to_image(game->mlx_ptr, "textures/pac_semi.xpm", &w, &h);
