...
/*   Updated: 2024/05/05 22:13:11 by apple            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    if (!ptr->black_wal || !ptr->collectible_ptr || !ptr->exit || !ptr->pac_semi_down ||
	 !ptr->pac_semi_left || !ptr->pac_semi_right || !ptr->pac_semi_up  || !ptr->wall_ptr)
    {
...
void	ft_load_image(s_data *game)
{
	...
	game->image.exit = mlx_xpm_file_to_image(game->mlx_ptr, "/Users/apple/Desktop/so_long/textures1/door.xpm",
			&w, &h);
	...
	game->image.pac_semi_right = mlx_xpm_file_to_image(game->mlx_ptr,
			"/Users/apple/Desktop/so_long/textures1/pac_semi_right.xpm", &w, &h);
